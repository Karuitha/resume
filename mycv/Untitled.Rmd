...
pacman::p_load(tidyverse, kableExtra, gt, vitae)
```

# Summary
Finance and research professional passionate about applying data analytics and machine learning to Business, Economics and Finance. 

I enjoy coding. 

Proficient in Ms Excel, R, Python, MySQL, PostgreSQL, Teradata, SQL Server, Git, and GitHub, and Tableau. Sound knowledge of Bash, Docker, Stata and E-views. 

Adept at conducting interviews, literature reviews, managing and organizing data, data synthesis and analysis, financial modelling, and communicating results to non-technical stakeholders. 

Capable of forecasting, inference, and producing reports and dashboards on KPI using statistical techniques like A/B tests, time series and regression analysis. 

Able to lead, train and mentor team members.

# Sofware

Proficient: *Ms Office | R | Python3 | Pandas | SQL & Databases (MySQL, PostgreSQL, Teradata, SQL Server)|Google BigQuery | Git | GitHub | Tableau*
...
# Key Skills
 ...
 - Problem-solver with good people skills & a strong work ethic. 
...
**May 2023 - Present: Data Scientist (Remote), Nuit Analytics, London, United Kingdom**

- Works closely with business stakeholders to understand business requirements and develop KPIs and metrics.

- Conducts data quality assurance using SQL and other tools to ensure accuracy, consistency, and completeness of data.

- Develops data transformations and manipulations using R and Python to clean and transform large and complex data sets.

- Designs and develops statistical models and machine learning algorithms using R and Python to uncover patterns and trends in data.

- Builds interactive dashboards and reports using Tableau and Shiny to communicate insights to business stakeholders.

- Develops and maintains data pipelines using Python and other tools to ensure timely and efficient data processing.
