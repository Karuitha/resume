...
Proficient: *Ms Office | R | Python & Pandas | Databases (MySQL, PostgreSQL, Teradata, SQL Server) | Git & GitHub*
...
- Teams to designs data collection instruments and evaluation criteria for the US businesses in Africa awards.
...
- Ensures data confidentiality, integrity availability.
...
- Adhered to budget requirements with planning and consistent expense monitoring while meeting the set milestones.
...
- Monitored budget, revenue and variance trends for US\$300,000 AED/USAID and AMREF grants, regularly apprising CEO and the board of company's financial standing.
 - Used QuickBooks to prepare monthly reconciliation of bank accounts and take corrective actions on deviations.
